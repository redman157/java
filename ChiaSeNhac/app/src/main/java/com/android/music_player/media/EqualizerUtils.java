...
public class EqualizerUtils {
    ...
    public static void openAudioEffectSession(@NonNull final Context context, int sessionId) {
    ...
    public static void closeAudioEffectSession(@NonNull final Context context, int sessionId) {
    ...
    public static void openEqualizer(@NonNull final Activity activity, MediaPlayer mediaPlayer) {
        if (mediaPlayer == null ||mediaPlayer.getAudioSessionId() == AudioEffect.ERROR_BAD_VALUE) {
