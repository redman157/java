package com.android.musicplayer.database;
...
import com.android.musicplayer.utils.Database;
    ...
    public void updatePlayList(int id, String title){
        String SQL_UPDATE =
                "UPDATE "+
                        ...
                        Database.ALL_PLAY_LISTS.NAME_PLAY_LIST + "= '"+ title +"'" +
                        " WHERE "+ Database.ALL_PLAY_LISTS.ID + "= '"+ id+ "' ";
